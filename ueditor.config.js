...
(function() {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,
        toolbars: [
            ["source", "undo", "redo", "insertunorderedlist", "insertorderedlist", "unlink", "link", "selectall", "|", "insertimage", "music", "insertvideo", "attachment", "date", "time", "horizontal", "spechars", "template", "background", "bold", "italic", "underline", "fontborder", "strikethrough", "forecolor", "backcolor", "superscript", "subscript", "justifyleft", "justifycenter", "justifyright", "justifyjustify", "directionalityltr", "directionalityrtl", "indent", "removeformat", "formatmatch", "autotypeset", "customstyle", "paragraph", "rowspacingbottom", "rowspacingtop", "lineheight", "fontfamily", "fontsize", "imagenone", "imageleft", "imageright", "imagecenter", "inserttable", "deletetable", "insertparagraphbeforetable", "deleterow", "deletecol", "insertrow", "insertcol", "mergecells", "splittocells", "splittocols", "splittorows", "mergedown", "mergeright", "addanimation"]
        ]
        ...
        //,initialContent: '欢迎使用Web版幻灯片编辑器!' //初始化编辑器的内容,也可以通过textarea/script给值，看官网例子
